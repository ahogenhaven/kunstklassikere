<link rel="stylesheet" href="http://kunstklassiker.dk/wp-content/themes/kunstklassikere/assets/css/slider.css">
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
<script src="http://kunstklassiker.dk/wp-content/themes/kunstklassikere/assets/js/slider.min.js"></script>
...
<div style="margin:0;padding:0;" class="slideshow-custom main <?php echo kadence_main_class(); ?>" role="main">
    ...
    <div class="callbacks_container" style="padding:0;margin:0;">
        <ul id="slider4" class="rowtight rslides">    
            <?php 
            ...
            <li style="margin:0;padding:0;" class="<?php echo $itemsize;?> <?php echo strtolower($tax); ?> all kad_portfolio_fade_in">
...
<div id="content" class="container">
    <div class="row">
        ...
        <div class="main <?php echo kadence_main_class(); ?>" role="main">
            ...
            else {$itemsize = 'tcol-md-25 tcol-sm-3 tcol-xs-4 tcol-ss-12'; $slidewidth = 269; $slideheight = 269; $md = 4; $sm = 3; $xs = 2; $ss = 1;}
            ?> 
            <?php $portfolio_item_excerpt = get_post_meta( $post->ID, '_kad_portfolio_item_excerpt', true ); $portfolio_item_types = get_post_meta( $post->ID, '_kad_portfolio_item_types', true );  ?>
            <?php $crop = true; ?>
            <?php $portfolio_cropheight = get_post_meta( $post->ID, '_kad_portfolio_img_crop', true ); if ($portfolio_cropheight != '') $slideheight = $portfolio_cropheight; ?>
